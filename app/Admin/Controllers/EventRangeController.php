...
class EventRangeController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new EventRange());
        
        $grid->column('id', __('ID'))->sortable();
        $grid->column('name', __('范围名称'));
    ...
    {
        $show = new Show(EventRange::findOrFail($id));
        
        $show->field('id', __('ID'));
        $show->field('name', __('范围名称'));
    ...
    {
        $form = new Form(new EventRange());
        
        $form->text('name', __('范围名称'));
